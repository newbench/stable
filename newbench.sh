...
print_intro() {
    ...
    echo " Global Speedtest   : $(_red "wget -qO- https://raw.githubusercontent.com/newbench/stable/refs/heads/main/newbench.sh | bash")"
    echo " Region Speedtest   : $(_red "wget -qO- https://raw.githubusercontent.com/newbench/stable/refs/heads/main/newbench.sh | bash -s -- -r <region>")"
    echo " iperf3 test        : $(_red "wget -qO- https://raw.githubusercontent.com/newbench/stable/refs/heads/main/newbench.sh | bash -s -- -iperf")"
    echo " Ping & Routing     : $(_red "wget -qO- https://raw.githubusercontent.com/newbench/stable/refs/heads/main/newbench.sh | bash -s -- -rt <region>")"
}
